...
public:
	...
	uint32_t time_date_stamp = 0x5eb4f980;
	uint32_t checksum = 0x1e59bde;

	uint32_t client_state = 0x111c190;
	uint32_t client_signon_state = 0x0098;
	uint32_t client_level_name = 0x01b8;

	uint32_t view_render = 0x3f3aad8;
	uint32_t view_matrix = 0x1b3bd0;
	uint32_t global_vars = 0x111be90;

	uint32_t input_system = 0x0118bac0;
	uint32_t input_button_state = 0xb0;

	uint32_t in_attack = 0x03f5c290;
	uint32_t in_jump = 0x03f5c308;

	uint32_t local_entity = 0x103fcfc;
	uint32_t entity_list = 0x1767348;
	...
	uint32_t player_helmet_armor_type = 0x41c4;
	...
	uint32_t player_resources = 0x3f5b928;
