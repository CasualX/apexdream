...
fn analyze(loot: &LootEntity) -> sdk::ItemId {
    ...
    if loot.weapon_name.0 != 0 {
        ...
        match loot.model_name.hash {
            ...
            MN::KNOCKDOWN_SHIELD => from_color(
                &loot.color,
                &[
                    KI::KnockdownShieldLv1,
                    KI::KnockdownShieldLv2,
                    KI::KnockdownShieldLv3,
                    KI::KnockdownShieldLv4,
                    KI::None,
                ],
            ),
            MN::BACKPACK_LIGHT => KI::BackpackLv1,
            MN::BACKPACK_MEDIUM => KI::BackpackLv2,
            MN::BACKPACK_HEAVY => from_color(
                &loot.color,
                &[
                    KI::None,
                    KI::None,
            ...
            MN::BARREL_STABILIZER => from_color(
                &loot.color,
                &[
                    KI::BarrelStabilizerLv1,
            ...
            MN::ENERGY_MAGAZINE => from_color(
                &loot.color,
                &[
                    KI::EnergyMagazineLv1,
                    KI::EnergyMagazineLv2,
                    KI::EnergyMagazineLv3,
                    KI::EnergyMagazineLv4,
                    KI::None,
                ],
            ),
            MN::SNIPER_MAGAZINE => from_color(
                &loot.color,
                &[
                    KI::SniperMagazineLv1,
                    KI::SniperMagazineLv2,
                    KI::SniperMagazineLv3,
                    KI::SniperMagazineLv4,
                    KI::None,
                ],
            ),
            MN::SHOTGUN_BOLT => from_color(
                &loot.color,
                &[
                    KI::ShotgunBoltLv1,
                    KI::ShotgunBoltLv2,
            ...
            MN::MODS_CHIP => {
                ...
                // TODO! find better way to check hop up
                /*				match (loot.bits.inside_opacity, loot.skin) {
                    _ => KI::LegendaryHopUp4,
            ...
            MN::EVAC_TOWER_LOOT => KI::EvacTower,
            MN::FULL_EVO_CACHE => KI::FullEvoCache,
            MN::MARVIN_ARM => KI::MrvnArm,
            MN::NESSIE => KI::NESSIE,
