...
impl Buttons {
	...
	pub fn read(&mut self, api: &mut Api, process: &GameProcess, data: &GameData) {
		let mut indices = [
			data.in_attack + 0, data.in_attack + 4, data.in_attack + 8,
			data.in_jump + 0, data.in_jump + 4, data.in_jump + 8,
			data.in_duck + 0, data.in_duck + 4, data.in_duck + 8,
			data.in_reload + 0, data.in_reload + 4, data.in_reload + 8,
			data.in_use + 0, data.in_use + 4, data.in_use + 8,
			data.in_zoom + 0, data.in_zoom + 4, data.in_zoom + 8,
			data.in_forward + 0, data.in_forward + 4, data.in_forward + 8,
			data.in_backward + 0, data.in_backward + 4, data.in_backward + 8,
			data.in_moveleft + 0, data.in_moveleft + 4, data.in_moveleft + 8,
			data.in_moveright + 0, data.in_moveright + 4, data.in_moveright + 8,
		];
