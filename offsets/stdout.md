...
<details>
<summary><code>class DT_ZiplinePhysicsNode</code></summary>
...
<details>
<summary><code>class DT_Ziprail extends DT_Zipline</code></summary>
...
```
{empty}: Null
active_crosshair_count: Int(1)
active_optic_appearance: String("")
activitymodifier1p: String("")
activitymodifier3p: String("")
ads_force_firstperson: Bool(false)
ads_fov_zoomfrac_end: Float(1.0)
ads_fov_zoomfrac_start: Float(0.0)
ads_move_speed_scale: Float(0.5)
aimassist_adspull_weaponclass: Special
aimassist_adspull_zoomEnd: Float(-1.0)
aimassist_adspull_zoomStart: Float(-1.0)
aimassist_disable_ads: Bool(false)
aimassist_disable_ads_humansonly: Bool(false)
aimassist_disable_ads_titansonly: Bool(false)
aimassist_disable_hipfire: Bool(false)
aimassist_disable_hipfire_humansonly: Bool(false)
aimassist_disable_hipfire_titansonly: Bool(false)
akimbo_weapon_flip_mouse_button_input: Bool(true)
allow_empty_fire: Bool(false)
allow_headshots: Bool(false)
allow_zoom_on_raise: Bool(true)
alt_fire_alternates_viewkick_yaw: Bool(false)
alt_fire_anim_count: Int(0)
alt_hand_3p_attach_name: String("")
althand_allow_mainhand_on_zipline: Bool(false)
ammo_clip_random_loss_on_npc_drop: Float(0.2)
ammo_clip_random_loss_on_npc_drop_chunksize: Int(1)
ammo_clip_reload_max: Int(-1)
ammo_clip_size: Int(-1)
ammo_default_total: Int(-1)
ammo_display: String("")
ammo_display_as_clips: Bool(true)
ammo_drains_to_empty_on_fire: Bool(false)
ammo_min_to_fire: Int(-1)
ammo_min_to_fire_autoreloads: Bool(true)
ammo_no_remove_from_clip: Bool(false)
ammo_no_remove_from_stockpile: Bool(false)
ammo_per_shot: Int(1)
ammo_pool_type: Enum("AmmoPoolType_t")
ammo_regen_takes_from_stockpile: Bool(false)
ammo_size_segmented_reload: Int(-1)
ammo_stockpile_max: Int(-1)
ammo_suck_behavior: Special
anim_alt_idleAttack: Int(0)
anim_stop_start_gesture_on_attack: Bool(false)
ap_aim_accuracy_easy: Float(-1.0)
ap_aim_accuracy_hard: Float(-1.0)
ap_leghead_ratio_easy: Float(-1.0)
ap_leghead_ratio_hard: Float(-1.0)
ap_max_burst: Float(-1.0)
ap_max_close_range_burst: Float(-1.0)
ap_max_engage_range: Float(-1.0)
ap_max_range_for_close_burst: Float(1000.0)
ap_min_burst: Float(-1.0)
ap_min_close_range_burst: Float(-1.0)
ap_min_engage_range: Float(-1.0)
ap_optimal_range: Float(-1.0)
ap_rest_time_between_bursts_max: Float(-1.0)
ap_rest_time_between_bursts_min: Float(-1.0)
ap_zoom_accuracy_easy: Float(-1.0)
ap_zoom_accuracy_hard: Float(-1.0)
ap_zoom_allowed: Bool(false)
attack_button_presses_ads: Bool(false)
attack_button_presses_melee: Bool(false)
auto_reload_no_ammo: Bool(true)
ballistic_type: Enum("eWeaponBallisticType")
blast_pattern: Special
blast_pattern_default_scale: Float(1.0)
blast_pattern_npc_scale: Float(1.0)
blast_pattern_zero_distance: Float(512.0)
body_skin: Int(0)
bodygroup10_set: Int(-1)
bodygroup11_set: Int(-1)
bodygroup12_set: Int(-1)
bodygroup13_set: Int(-1)
bodygroup14_set: Int(-1)
bodygroup15_set: Int(-1)
bodygroup16_set: Int(-1)
bodygroup17_set: Int(-1)
bodygroup18_set: Int(-1)
bodygroup19_set: Int(-1)
bodygroup1_set: Int(-1)
bodygroup20_set: Int(-1)
bodygroup21_set: Int(-1)
bodygroup22_set: Int(-1)
bodygroup23_set: Int(-1)
bodygroup24_set: Int(-1)
bodygroup25_set: Int(-1)
bodygroup26_set: Int(-1)
bodygroup27_set: Int(-1)
bodygroup28_set: Int(-1)
bodygroup29_set: Int(-1)
bodygroup2_set: Int(-1)
bodygroup30_set: Int(-1)
bodygroup31_set: Int(-1)
bodygroup32_set: Int(-1)
bodygroup3_set: Int(-1)
bodygroup4_set: Int(-1)
bodygroup5_set: Int(-1)
bodygroup6_set: Int(-1)
bodygroup7_set: Int(-1)
bodygroup8_set: Int(-1)
bodygroup9_set: Int(-1)
bodygroup_ads_scope_set: Int(-1)
bodygroup_ammo_index_count: Int(0)
bolt_bounce_frac: Float(0.0)
bolt_gravity_enabled: Bool(true)
bolt_hitsize: Float(0.0)
bolt_hitsize_grow1_size: Float(0.0)
bolt_hitsize_grow1_time: Float(0.0)
bolt_hitsize_grow2_size: Float(0.0)
bolt_hitsize_grow2_time: Float(0.0)
bolt_hitsize_growfinal_lerptime: Float(0.0)
bolt_hitsize_growfinal_size: Float(0.0)
bolt_zero_distance: Float(4096.0)
bounce_effect_table: Asset
breaks_cloak: Bool(true)
burst_fire_count: Int(0)
burst_fire_delay: Float(0.0)
burst_fire_delay_ramp_bursts: Int(0)
burst_fire_delay_ramp_max: Float(0.0)
burst_or_looping_fire_sound_end: String("")
burst_or_looping_fire_sound_end_1p: String("")
burst_or_looping_fire_sound_end_3p: String("")
burst_or_looping_fire_sound_end_npc: String("")
burst_or_looping_fire_sound_middle: String("")
burst_or_looping_fire_sound_middle_1p: String("")
burst_or_looping_fire_sound_middle_3p: String("")
burst_or_looping_fire_sound_middle_npc: String("")
burst_or_looping_fire_sound_resume_1p: String("")
burst_or_looping_fire_sound_resume_3p: String("")
burst_or_looping_fire_sound_resume_npc: String("")
burst_or_looping_fire_sound_start: String("")
burst_or_looping_fire_sound_start_1p: String("")
burst_or_looping_fire_sound_start_3p: String("")
burst_or_looping_fire_sound_start_npc: String("")
bypass_semiauto_hold_protection: Bool(false)
can_attack_when_dead: Bool(false)
can_energize_when_energized: Bool(false)
challeng_req: String("")
challenge_tier: Int(0)
chance_for_bonus_last_shot_in_clip: Float(0.0)
charge_additional_damage_multiplier: Float(0.0)
charge_allow_anim_updates: Bool(true)
charge_allow_hold_when_full: Bool(false)
charge_allow_melee: Bool(true)
charge_allow_midway_charge: Bool(true)
charge_attack_min_charge_required: Float(0.0)
charge_cooldown_delay: Float(0.0)
charge_cooldown_time: Float(0.0)
charge_curve_coefficients: Vector
charge_delay_when_triggered_by_ADS: Float(0.0)
charge_drain_sound_1p: String("")
charge_drain_sound_3p: String("")
charge_drain_sound_seek_to_charge_fraction: Bool(false)
charge_drain_sound_stop_when_empty: Bool(true)
charge_effect2_1p: Asset
charge_effect2_3p: Asset
charge_effect2_attachment: String("")
charge_effect2_attachment_scoped: String("")
charge_effect_1p: Asset
charge_effect_3p: Asset
charge_effect_attachment: String("")
charge_effect_attachment_scoped: String("")
charge_effect_burn_mod_1p: Asset
charge_effect_burn_mod_3p: Asset
charge_effect_show_during_drain: Bool(true)
charge_end_forces_fire: Bool(false)
charge_finish_primary_attack_on_cancel: Bool(false)
charge_fraction_scales_anim_rate: Bool(false)
charge_full_sound_1p: String("")
charge_full_sound_3p: String("")
charge_is_triggered_by_ADS: Bool(false)
charge_level_base: Int(0)
charge_levels: Int(0)
charge_maintained_until_fired: Bool(false)
charge_overheat_cooldown_delay: Float(0.0)
charge_overheat_cooldown_time: Float(0.0)
charge_overheat_cooldown_time_late1: Float(0.0)
charge_overheat_cooldown_time_late2: Float(0.0)
charge_overheat_cooldown_time_late3: Float(0.0)
charge_overheats_when_full: Bool(false)
charge_remain_full_when_fired: Bool(false)
charge_require_input: Bool(true)
charge_rumble_max: Int(0)
charge_rumble_min: Int(0)
charge_sound_1p: String("")
charge_sound_3p: String("")
charge_sound_seek_to_charge_fraction: Bool(false)
charge_sound_stop_when_full: Bool(true)
...
cooldown_viewkick_hardScale: Float(0.0)
cooldown_viewkick_pitch_base: Float(0.0)
cooldown_viewkick_pitch_random: Float(0.0)
cooldown_viewkick_pitch_random_innerexclude: Float(0.0)
cooldown_viewkick_softScale: Float(0.0)
cooldown_viewkick_yaw_base: Float(0.0)
cooldown_viewkick_yaw_random: Float(0.0)
cooldown_viewkick_yaw_random_innerexclude: Float(0.0)
core_build_time: Float(0.0)
core_duration: Float(0.0)
critical_hit: Bool(true)
critical_hit_damage_scale: Float(1.0)
crosshair_force_sprint_fade_disabled: Bool(false)
custom_bool_0: Bool(false)
custom_bool_1: Bool(false)
custom_bool_2: Bool(false)
custom_bool_3: Bool(false)
custom_bool_4: Bool(false)
custom_bool_5: Bool(false)
custom_bool_6: Bool(false)
custom_bool_7: Bool(false)
custom_float_0: Float(0.0)
custom_float_1: Float(0.0)
custom_float_2: Float(0.0)
custom_float_3: Float(0.0)
custom_float_4: Float(0.0)
custom_float_5: Float(0.0)
custom_float_6: Float(0.0)
custom_float_7: Float(0.0)
custom_haptics_control: Float(0.0)
custom_int_0: Int(0)
custom_int_1: Int(0)
custom_int_2: Int(0)
custom_int_3: Int(0)
...
custom_int_6: Int(0)
custom_int_7: Int(0)
custom_laser_sight_color_enabled: Bool(false)
cycle_to_next_when_out_of_ammo: Bool(true)
damage_additional_bullets: Int(0)
damage_additional_bullets_titanarmor: Int(0)
damage_falloff_type: Enum("eWeaponDamageFalloffType")
damage_far_distance: Float(-1.0)
damage_far_value: Int(-1)
damage_far_value_titanarmor: Int(-1)
damage_flags: Special
damage_headshot_scale: Float(1.5)
damage_inverse_distance: Float(-1.0)
damage_leg_scale: Float(1.0)
damage_near_distance: Float(-1.0)
damage_near_value: Int(-1)
damage_near_value_titanarmor: Int(-1)
damage_rodeo: Int(0)
damage_shield_scale: Float(1.0)
damage_unshielded_scale: Float(1.0)
damage_very_far_distance: Float(-1.0)
damage_very_far_value: Int(-1)
damage_very_far_value_titanarmor: Int(-1)
deploy_allow_ads: Bool(false)
deploy_time: Float(0.0)
deploycatch_time: Float(0.0)
deployfirst_time: Float(0.0)
description: String("")
destroy_on_all_ammo_take: Bool(true)
destroy_on_drop: Bool(false)
disable_zoomed_rechamber: Bool(false)
dof_nearDepthEnd: Float(7.7)
dof_nearDepthStart: Float(7.5)
dof_zoom_focusArea_Bottom: Float(0.0)
dof_zoom_focusArea_Horizontal: Float(0.0)
dof_zoom_focusArea_Top: Float(0.0)
dof_zoom_nearDepthEnd: Float(7.7)
dof_zoom_nearDepthStart: Float(7.6)
enable_highlight_networking_on_creation: Bool(false)
energize_activity_time: Float(5.0)
energize_effect0_1p: Asset
energize_effect0_3p: Asset
energize_effect0_attachment: String("")
energize_effect0_attachment_scope: String("")
energized_duration: Float(120.0)
energized_primary_attack_effect_1p: Asset
energized_primary_attack_effect_3p: Asset
energized_time_consumed_per_shot: Float(15.0)
explosion_damage: Int(0)
explosion_damage_flags: Special
explosion_damage_heavy_armor: Int(-1)
explosion_damages_owner: Bool(true)
explosion_inner_radius: Float(0.0)
explosion_shake_amplitude: Float(10.0)
explosion_shake_duration: Float(1.0)
explosion_shake_frequency: Float(35.0)
explosion_shake_radius: Float(-1.0)
explosionradius: Float(0.0)
fast_swap_from: Bool(false)
fast_swap_to: Bool(false)
fire_duration: Float(0.0)
fire_in_real_world_while_phased: Bool(false)
fire_mode: Enum("eWeaponFireMode")
fire_rate: Float(1.0)
fire_rate_max: Float(0.0)
fire_rate_max_time_cooldown: Float(0.0)
fire_rate_max_time_speedup: Float(0.0)
fire_rate_max_use_ads: Bool(false)
fire_rumble: String("")
fire_sound_1: String("")
fire_sound_1_npc: String("")
fire_sound_1_player_1p: String("")
fire_sound_1_player_3p: String("")
fire_sound_2: String("")
fire_sound_2_npc: String("")
fire_sound_2_player_1p: String("")
fire_sound_2_player_3p: String("")
fire_sound_3: String("")
fire_sound_3_npc: String("")
fire_sound_3_player_1p: String("")
fire_sound_3_player_3p: String("")
fire_sound_first_shot: String("")
fire_sound_first_shot_npc: String("")
fire_sound_first_shot_player_1p: String("")
fire_sound_first_shot_player_3p: String("")
fire_sound_partial_burst_player_1p: String("")
...
fx_muzzle_flash2_attach_scoped: String("")
fx_muzzle_flash2_view: Asset
fx_muzzle_flash2_world: Asset
fx_muzzle_flash_attach: String("")
fx_muzzle_flash_attach_scoped: String("")
fx_muzzle_flash_view: Asset
fx_muzzle_flash_world: Asset
fx_shell_eject2_attach: String("")
fx_shell_eject2_attach_scoped: String("")
fx_shell_eject2_view: Asset
fx_shell_eject2_world: Asset
fx_shell_eject_attach: String("")
fx_shell_eject_attach_scoped: String("")
fx_shell_eject_view: Asset
fx_shell_eject_world: Asset
gamepad_use_yaw_speed_for_pitch_ads: Bool(false)
give_command_forced_inventory_slot: Int(-2)
grapple_maxLength: Float(800.0)
grapple_maxLengthVert: Float(800.0)
grapple_power_required: Float(100.0)
grapple_power_use_rate: Float(50.0)
grapple_weapon: Bool(false)
grenade_angle_dependant_throw_max_speed_angle: Float(0.0)
grenade_angle_dependant_throw_min_speed: Float(0.0)
grenade_angle_dependant_throw_min_speed_angle: Float(-89.0)
grenade_arc_impact_indicator_effect: Asset
grenade_arc_indicator_bounce_count: Int(1)
grenade_arc_indicator_effect: Asset
grenade_arc_indicator_effect_first: Asset
grenade_arc_indicator_ignore_base_velocity: Bool(false)
grenade_arc_indicator_max_duration: Float(0.0)
grenade_arc_indicator_show_during_toss: Bool(false)
grenade_arc_indicator_show_from_hip: Bool(false)
grenade_arc_indicator_show_in_sprint_if_ready: Bool(false)
grenade_arc_indicator_show_landing_position: Bool(false)
grenade_arc_indicator_show_on_raise_if_ready: Bool(false)
grenade_arc_indicator_show_while_airborne: Bool(false)
grenade_arc_indicator_smooth: Bool(false)
grenade_arc_indicator_smooth_radius: Float(25.0)
grenade_bounce_extra_vertical_randomness: Float(0.2)
grenade_bounce_randomness: Float(0.2)
grenade_bounce_vel_frac_along_normal: Float(0.5)
grenade_bounce_vel_frac_shallow: Float(0.5)
grenade_bounce_vel_frac_sharp: Float(0.3)
grenade_can_roll: Bool(true)
grenade_death_drop_velocity_extraUp: Float(0.2)
grenade_death_drop_velocity_scale: Float(0.2)
grenade_drop_to_ground_bounce_vel_frac: Float(40.0)
grenade_drop_to_ground_on_bounce: Bool(false)
grenade_drop_velocity: Float(450.0)
grenade_fuse_time: Float(0.0)
grenade_hull_maxs: Vector
grenade_hull_mins: Vector
grenade_ignition_time: Float(0.0)
grenade_ignore_friendly_players: Bool(false)
grenade_ignore_planted_grenades: Bool(false)
grenade_mover_destroy_when_planted: Bool(false)
grenade_orient_to_velocity: Bool(false)
grenade_radius_horizontal: Float(-1.0)
grenade_radius_vertical: Float(-1.0)
grenade_roll_vel_frac_per_second: Float(0.1)
grenade_touch_triggers_on_impact: Bool(false)
grenade_use_mask_ability: Bool(false)
grenade_view_launch_offset: Vector
has_energized: Int(0)
has_linked_anims: Bool(false)
headshot_distance: Float(50.0)
heat_per_bullet: Float(0.05)
hide_holstered_sidearm_when_active: Bool(false)
hide_when_holstered: Bool(false)
holster_angles_offset: Vector
holster_offset: Vector
holster_time: Float(0.0)
holster_type: Enum("eWeaponHolsterType")
holstermodel: WeaponString
hud_icon: Asset
idle_sound_player_1p: String("")
ignition_distance: Float(0.0)
ignition_effect: String("")
ignition_sound: String("")
ignore_3p_activity_mod_during_consumable: Bool(false)
impact_effect_table: Asset
impulse_force: Float(0.0)
...
is_semi_auto: Bool(false)
is_twohanded_consumable: Bool(false)
l_trig_custom_mode: Int(-1)
l_trig_custom_str: Int(-1)
lifetime_shots_default: Int(-1)
loadout_child_ref: String("")
loadout_parent_ref: String("")
loadout_selectable: Bool(false)
loadout_type: String("")
locks_weapon_change: Bool(false)
looping_sounds: Bool(false)
low_ammo_fraction: Float(0.0)
low_ammo_sound_name_1: String("")
low_ammo_sound_name_10: String("")
low_ammo_sound_name_11: String("")
low_ammo_sound_name_12: String("")
low_ammo_sound_name_13: String("")
low_ammo_sound_name_14: String("")
low_ammo_sound_name_15: String("")
low_ammo_sound_name_2: String("")
low_ammo_sound_name_3: String("")
low_ammo_sound_name_4: String("")
low_ammo_sound_name_5: String("")
low_ammo_sound_name_6: String("")
low_ammo_sound_name_7: String("")
low_ammo_sound_name_8: String("")
low_ammo_sound_name_9: String("")
low_ammo_sound_range_name_1: String("")
low_ammo_sound_range_name_2: String("")
low_ammo_sound_range_name_3: String("")
low_ammo_sound_range_start_1: Int(0)
low_ammo_sound_range_start_2: Int(0)
low_ammo_sound_range_start_3: Int(0)
lower_time: Float(0.0)
max_cook_time: Float(-1.0)
melee_angle: Float(30.0)
melee_anim_1p_number: Int(1)
melee_anim_3p: String("")
melee_attack_animtime: Float(0.0)
melee_can_hit_humansized: Bool(false)
melee_can_hit_titans: Bool(false)
melee_damage: Int(-1)
...
melee_lunge_target_range: Float(125.0)
melee_lunge_time: Float(0.2)
melee_raise_recovery_animtime_normal: Float(0.75)
melee_raise_recovery_animtime_quick: Float(0.0)
melee_range: Float(60.0)
melee_respect_next_attack_time: Bool(false)
melee_rumble_on_hit: String("")
melee_rumble_on_hit_partial: String("")
melee_sound_attack_1p: String("")
melee_sound_attack_3p: String("")
menu_alt_icon: String("")
menu_icon: String("")
menu_image: String("")
minimap_reveal_distance: Float(32000.0)
mod_description: String("")
mod_print_name: String("")
mod_short_print_name: String("")
move_speed_modifier: Float(1.0)
move_speed_modifier_when_out_of_ammo: Float(-1.0)
net_bullet_fix: Bool(true)
never_drop: Bool(false)
npc_accuracy_multiplier_heavy_armor: Float(1.0)
npc_accuracy_multiplier_npc: Float(1.0)
npc_accuracy_multiplier_pilot: Float(1.0)
npc_aim_at_feet: Bool(false)
npc_aim_at_feet_vs_heavy_armor: Bool(false)
npc_attack_cone_angle: Float(-1.0)
npc_burst_radius_distribution_bias_max_precision: Float(1.0)
npc_burst_radius_distribution_bias_min_precision: Float(-1.0)
npc_burst_radius_max_precision: Float(10.0)
npc_burst_radius_min_precision: Float(60.0)
npc_burst_secondary: Int(-1)
npc_charge_time_max: Float(0.0)
npc_charge_time_min: Float(0.0)
npc_clear_charge_if_not_fired: Bool(false)
npc_compensate_gravity: Bool(false)
npc_damage_far_distance: Float(-1.0)
npc_damage_far_value: Int(-1)
npc_damage_far_value_titanarmor: Int(-1)
npc_damage_near_distance: Float(-1.0)
npc_damage_near_value: Int(-1)
npc_damage_near_value_titanarmor: Int(-1)
npc_damage_very_far_distance: Float(-1.0)
npc_damage_very_far_value: Int(-1)
npc_damage_very_far_value_titanarmor: Int(-1)
npc_dangerous_to_heavy_armor: Bool(false)
npc_dangerous_to_normal_armor: Bool(false)
npc_directed_fire_ang_limit: Float(0.0)
npc_explosion_damage: Int(0)
npc_explosion_damage_heavy_armor: Int(-1)
npc_fire_at_enemy_defense_time: Float(-1.0)
npc_full_auto_vs_heavy_armor: Bool(false)
npc_lead_projectiles: Bool(false)
npc_lead_projectiles_fraction_max_precision: Float(1.0)
npc_lead_projectiles_fraction_min_precision: Float(0.0)
npc_lob_shot_pitch: Float(0.0)
npc_max_burst: Int(1)
npc_max_burst_max_precision: Int(1)
npc_max_burst_min_precision: Int(1)
npc_max_engage_range: Float(0.0)
npc_max_engage_range_heavy_armor: Float(0.0)
npc_max_range: Float(8000.0)
npc_max_range_secondary: Float(1500.0)
npc_max_rest_time_between_bursts_max_precision: Float(-1.0)
npc_max_rest_time_between_bursts_min_precision: Float(-1.0)
npc_min_burst: Int(1)
npc_min_burst_max_precision: Int(1)
npc_min_burst_min_precision: Int(1)
npc_min_engage_range: Float(0.0)
npc_min_engage_range_heavy_armor: Float(0.0)
npc_min_range: Float(0.0)
npc_min_range_secondary: Float(0.0)
npc_min_rest_time_between_bursts_max_precision: Float(-1.0)
npc_min_rest_time_between_bursts_min_precision: Float(-1.0)
npc_miss_fast_player: Bool(true)
npc_pre_fire_delay: Float(-1.0)
npc_pre_fire_delay_interval: Float(-1.0)
npc_refresh_burst_location_per_shot: Bool(false)
npc_reload_enabled: Int(-1)
npc_rest_time_between_bursts_expedite: Float(-1.0)
npc_rest_time_between_bursts_max: Float(-1.0)
npc_rest_time_between_bursts_min: Float(-1.0)
npc_rest_time_secondary: Float(0.0)
npc_self_explosion_safety: Bool(true)
npc_spread_cone_distribution_bias_max_precision: Float(1.0)
npc_spread_cone_distribution_bias_min_precision: Float(-1.0)
npc_spread_cone_focus_time: Float(-1.0)
npc_spread_cone_max_precision: Float(0.5)
npc_spread_cone_min_precision: Float(1.25)
npc_spread_defocused_cone_multiplier: Float(2.5)
npc_spread_pattern_focus_time: Float(-1.0)
npc_spread_pattern_not_in_fov_factor: Float(0.2)
npc_spread_pattern_not_in_fov_time: Float(2.5)
npc_suppress_abs_position: Bool(false)
npc_suppress_lsp_allowed: Bool(true)
npc_use_ads_move_speed_scale: Bool(true)
npc_use_long_duration: Float(1.4)
npc_use_max_damage: Float(1400.0)
npc_use_min_damage: Float(700.0)
npc_use_min_projectile_damage: Float(0.0)
npc_use_short_duration: Float(0.9)
npc_use_strict_muzzle_dir: Bool(false)
npc_vortex_block: Bool(true)
object_placement_clearance_behind: Float(0.0)
object_placement_distance_max: Float(128.0)
object_placement_distance_to_ground_max: Float(20.0)
object_placement_drop_to_ground_offset_max: Float(72.0)
object_placement_force_upright: Bool(false)
object_placement_ground_penetration_max: Float(10.0)
object_placement_hill_angle_max: Float(45.0)
object_placement_ignore_players: Bool(false)
object_placement_last_good_angle_max: Float(25.0)
object_placement_last_good_distance_max: Float(100.0)
object_placement_model: Asset
object_placement_percent_off_ledge_max: Float(0.25)
object_placement_run_on_primary_attack: Bool(false)
object_placement_top_distance_pierce_max: Float(0.0)
...
offhand_active_slot: Enum("eActiveInventorySlot")
offhand_allow_swap_to_on_zipline: Bool(true)
offhand_allows_inpect: Bool(false)
offhand_blocks_sprint: Bool(false)
offhand_cancelled_by_melee: Bool(false)
offhand_chargeEnd_holster_on_noattack: Bool(true)
offhand_clear_zoom_on_activate: Bool(false)
offhand_deactivate_on_jump_toggle_or_release: Bool(false)
offhand_default_inventory_slot: Int(0)
offhand_deploy_requires_input: Bool(false)
offhand_hidden_for_fullscreen_ads: Bool(false)
offhand_hold_enabled: Bool(true)
offhand_holds_on_tactical: Bool(false)
offhand_hybrid_alt_hand_uses_attack_button: Bool(true)
offhand_hybrid_block_switch_if_empty: Bool(false)
offhand_hybrid_reset_shot_count_on_attack: Bool(true)
offhand_hybrid_switch_on_attack: Bool(true)
offhand_hybrid_switch_on_lower: Bool(false)
offhand_hybrid_tracks_projectiles: Bool(false)
offhand_instant_swap_to_offhand: Bool(false)
offhand_interupts_weapon_anims: Bool(false)
offhand_only_swap_to_on_ground: Bool(false)
offhand_raise_is_interrupt_resumable: Bool(false)
offhand_restore_after_melee: Bool(false)
offhand_switch_force_draw: Bool(false)
offhand_switch_on_attack: Bool(true)
offhand_switch_slot: Bool(false)
offhand_toss_activates_on_attack: Bool(false)
offhand_toss_hold_is_resumable: Bool(false)
offhand_transition_has_attach_detach_anim_events: Bool(false)
offhand_uses_hud_ammo_status: Bool(false)
offhand_wants_first_deploy: Bool(false)
ordnance_crosshair_always_on_start_index: Int(-1)
pass_through_damage_preserved_scale: Float(1.0)
pass_through_depth: Int(0)
play_one_handed_alt_hand_anim_on_mainhand: Bool(false)
player_hands_attachment: String("")
player_hands_effect: Asset
playermodel: WeaponString
pre_ignition_damage: Int(-1)
pre_ignition_damage_titanarmor: Int(-1)
pre_ignition_flight_sound: String("")
pre_ignition_impact_effect_table: Asset
pre_ignition_npc_damage: Int(-1)
pre_ignition_npc_damage_titanarmor: Int(-1)
pre_ignition_speed: Float(50.0)
pre_ignition_trail_effect: String("")
primary_attack_ignores_spread: Bool(false)
primary_fire_does_not_block_sprint: Bool(false)
printname: String("")
proficiency_average_additional_rest: Float(0.0)
proficiency_average_bias: Float(0.5)
proficiency_average_spreadscale: Float(3.0)
proficiency_good_additional_rest: Float(0.0)
proficiency_good_bias: Float(0.7)
proficiency_good_spreadscale: Float(2.0)
proficiency_perfect_additional_rest: Float(0.0)
proficiency_perfect_bias: Float(1.0)
proficiency_perfect_spreadscale: Float(1.0)
proficiency_poor_additional_rest: Float(0.0)
proficiency_poor_bias: Float(0.0)
proficiency_poor_spreadscale: Float(5.0)
proficiency_very_good_additional_rest: Float(0.0)
proficiency_very_good_bias: Float(0.9)
proficiency_very_good_spreadscale: Float(1.5)
projectile_air_friction: Float(0.0)
projectile_air_friction_2: Float(0.0)
projectile_air_friction_final: Float(0.0)
projectile_airburst_on_death: Bool(false)
projectile_bounce_damage_reduction_scale: Float(1.0)
projectile_chasecamDistanceMax: Float(75.0)
projectile_chasecamMaxOrbitDepth: Float(1.0)
projectile_chasecamMaxPitchUp: Float(-20.0)
projectile_chasecamOffsetForward: Float(-12.0)
projectile_chasecamOffsetRight: Float(5.0)
projectile_chasecamOffsetUp: Float(5.0)
projectile_collide_with_owner_grace_time: Float(-1.0)
projectile_damages_owner: Bool(false)
projectile_death_sound: String("")
projectile_do_predict_impact_effects: Bool(true)
projectile_drag_coefficient: Float(0.0)
projectile_drift_intensity: Float(0.5)
projectile_drift_windiness: Float(10.0)
projectile_first_person_offset_fraction: Float(0.5)
projectile_flamethrower_status_effect_duration: Float(1.0)
projectile_flamethrower_status_effect_range: Float(0.0)
projectile_flight_sound: String("")
projectile_gravity_scale: Float(1.0)
projectile_gravity_scale_2: Float(0.0)
projectile_gravity_scale_final: Float(0.0)
projectile_gravity_scale_time_2: Float(0.0)
projectile_gravity_scale_time_final: Float(0.0)
projectile_inherit_base_velocity_scale: Float(1.0)
projectile_inherit_owner_velocity_scale: Float(0.0)
projectile_killreplay_enabled: Bool(false)
projectile_launch_pitch_offset: Float(0.0)
projectile_launch_speed: Float(1.0)
projectile_lifetime: Float(0.0)
projectile_max_deployed: Int(0)
projectile_muzzle_offset_decay_max_time: Float(0.0)
projectile_predict_move_to_impact: Bool(true)
projectile_ricochet_max_count: Int(0)
projectile_speed_decay: Float(0.0)
projectile_speed_reduction_factor: Float(0.0)
projectile_straight_radius_max: Float(6.0)
projectile_straight_radius_min: Float(0.0)
projectile_straight_time_max: Float(4.0)
projectile_straight_time_min: Float(0.5)
projectile_trail_effect_0_1p: Asset
projectile_trail_effect_0_3p: Asset
projectile_trail_effect_1_1p: Asset
projectile_trail_effect_1_3p: Asset
projectile_trail_effect_2_1p: Asset
projectile_trail_effect_2_3p: Asset
projectile_trail_effect_3_1p: Asset
projectile_trail_effect_3_3p: Asset
projectile_trail_effect_4_1p: Asset
projectile_trail_effect_4_3p: Asset
projectile_trail_start_from_origin: Bool(false)
projectile_visible_to_smart_ammo: Bool(true)
projectilemodel: Asset
projectiles_per_shot: Int(1)
r_trig_custom_mode: Int(-1)
r_trig_custom_str: Int(-1)
raise_from_sprint_time: Float(0.0)
raise_time: Float(0.0)
rapid_fire_overrides_min_ammo: Bool(false)
readyhint: String("")
readymessage: String("")
rechamber_time: Float(0.0)
rechamber_time_late1: Float(0.0)
rechamber_time_late2: Float(0.0)
rechamber_time_late3: Float(0.0)
red_crosshair_range: Float(-1.0)
regen_ammo_refill_rate: Float(0.0)
regen_ammo_refill_start_delay: Float(0.0)
regen_ammo_sound_range_name_1: String("")
regen_ammo_sound_range_name_2: String("")
regen_ammo_sound_range_name_3: String("")
regen_ammo_sound_range_start_1: Int(-1)
regen_ammo_sound_range_start_2: Int(-1)
regen_ammo_sound_range_start_3: Int(-1)
regen_ammo_stockpile_drain_rate_when_charging: Float(0.0)
regen_ammo_stockpile_max_fraction: Float(0.0)
regen_ammo_while_firing: Bool(false)
reload_allow_ads: Bool(false)
reload_alt_anim: Bool(false)
reload_enabled: Bool(true)
reload_is_segmented: Bool(false)
reload_no_auto_if_ads_pressed: Bool(false)
reload_time: Float(0.0)
reload_time_late1: Float(0.0)
reload_time_late2: Float(0.0)
reload_time_late3: Float(0.0)
reload_time_late4: Float(0.0)
reload_time_late5: Float(0.0)
reloadempty_time: Float(0.0)
reloadempty_time_late1: Float(0.0)
reloadempty_time_late2: Float(0.0)
reloadempty_time_late3: Float(0.0)
reloadempty_time_late4: Float(0.0)
reloadempty_time_late5: Float(0.0)
reloadsegment_time_end: Float(0.0)
reloadsegment_time_loop: Float(0.0)
reloadsegmentempty_time_end: Float(0.0)
rui_crosshair_index: Int(0)
shared_energy_charge_cost: Int(0)
shared_energy_cost: Int(0)
shortprintname: String("")
show_grenade_indicator: Bool(false)
show_grenade_indicator_to_owner: Bool(false)
show_pre_modded_tracer: Bool(true)
silenced: Bool(false)
smart_ammo_active_shot_damage_multiplier: Float(1.0)
smart_ammo_active_shot_on_first_lock_only: Bool(false)
smart_ammo_active_shot_time: Float(0.0)
smart_ammo_alert_npc_fraction: Float(0.3)
smart_ammo_allow_ads_lock: Bool(false)
smart_ammo_allow_hip_fire_lock: Bool(false)
smart_ammo_allow_search_while_firing: Bool(false)
smart_ammo_allow_search_while_inactive: Bool(false)
smart_ammo_alt_lock_style: Bool(false)
smart_ammo_always_do_burst: Bool(false)
smart_ammo_apply_new_target_delay_to_first_target: Bool(false)
smart_ammo_draw_acquisition_lines: Bool(false)
smart_ammo_hold_and_reset_after_all_locks: Float(-1.0)
smart_ammo_lock_effect2_1p: Asset
smart_ammo_lock_effect2_3p: Asset
smart_ammo_lock_effect2_attachment: String("")
smart_ammo_lock_effect_1p: Asset
smart_ammo_lock_effect_3p: Asset
smart_ammo_lock_effect_attachment: String("")
smart_ammo_looping_sound_acquiring: String("")
smart_ammo_looping_sound_locked: String("")
smart_ammo_max_targeted_burst: Int(-1)
smart_ammo_max_targets: Int(5)
smart_ammo_max_trackers_per_target: Int(1)
smart_ammo_new_target_delay: Float(0.3)
smart_ammo_npc_targets_must_be_tracked: Bool(false)
smart_ammo_only_search_on_charge: Bool(false)
smart_ammo_other_targets_must_be_tracked: Bool(false)
smart_ammo_player_targets_must_be_tracked: Bool(false)
smart_ammo_search_angle: Float(1.0)
smart_ammo_search_distance: Float(0.0)
smart_ammo_search_enemy_team: Bool(true)
smart_ammo_search_friendly_team: Bool(false)
smart_ammo_search_neutral_team: Bool(true)
smart_ammo_search_npcs: Bool(true)
smart_ammo_search_phase_shift: Bool(false)
smart_ammo_search_players: Bool(true)
smart_ammo_stick_to_fully_locked_targets: Bool(true)
smart_ammo_target_confirmed_sound: String("")
smart_ammo_target_confirming_sound: String("")
smart_ammo_target_found_sound: String("")
smart_ammo_target_lost_sound: String("")
smart_ammo_target_max_locks_heavy: Float(-1.0)
smart_ammo_target_max_locks_normal: Float(-1.0)
smart_ammo_target_npc_lock_factor: Float(1.0)
smart_ammo_targeting_time_max: Float(2.0)
smart_ammo_targeting_time_max_npc: Float(-1.0)
smart_ammo_targeting_time_min: Float(0.5)
smart_ammo_targeting_time_min_npc: Float(-1.0)
smart_ammo_targeting_time_modifier_cloaked: Float(2.0)
smart_ammo_targeting_time_modifier_projectile: Float(0.0)
smart_ammo_targeting_time_modifier_projectile_owner: Float(0.35)
smart_ammo_track_cloaked_targets: Bool(false)
smart_ammo_tracked_targets_check_visibility: Bool(false)
smart_ammo_tracker_status_effects: Bool(false)
smart_ammo_unlock_debounce_time: Float(0.15)
sound_cook_warning: String("")
sound_deploy_1p: String("")
sound_deploy_3p: String("")
sound_disabledfire: String("")
sound_dryfire: String("")
sound_grenade_projectile: String("")
sound_pickup: String("")
sound_throw_1p: String("")
sound_throw_3p: String("")
sound_weapon_ready: String("")
sound_zoom_in: String("")
sound_zoom_out: String("")
spread_air_ads: Float(-1.0)
spread_air_ads_moving: Float(-1.0)
spread_air_hip: Float(-1.0)
spread_air_hip_moving: Float(-1.0)
spread_crouch_ads: Float(-1.0)
spread_crouch_hip: Float(-1.0)
spread_decay_delay: Float(0.1)
spread_decay_rate: Float(5.0)
spread_kick_on_fire_air_ads: Float(0.0)
spread_kick_on_fire_air_hip: Float(0.0)
spread_kick_on_fire_crouch_ads: Float(0.0)
spread_kick_on_fire_crouch_hip: Float(0.0)
spread_kick_on_fire_stand_ads: Float(0.0)
spread_kick_on_fire_stand_hip: Float(0.0)
spread_max_kick_air_ads: Float(0.0)
spread_max_kick_air_hip: Float(0.0)
spread_max_kick_crouch_ads: Float(0.0)
spread_max_kick_crouch_hip: Float(0.0)
spread_max_kick_stand_ads: Float(0.0)
spread_max_kick_stand_hip: Float(0.0)
spread_min_kick: Float(0.0)
spread_moving_decay_rate: Float(75.0)
spread_moving_increase_rate: Float(75.0)
spread_stand_ads: Float(-1.0)
spread_stand_hip: Float(5.0)
spread_stand_hip_run: Float(-1.0)
spread_stand_hip_sprint: Float(-1.0)
spread_time_to_max: Float(0.0)
spread_wallhanging: Float(-1.0)
spread_wallrunning: Float(-1.0)
sprint_fractional_anims: Bool(false)
sprintcycle_time: Float(0.0)
stat_accuracy: Float(0.0)
stat_damage: Float(0.0)
stat_range: Float(0.0)
stat_rof: Float(0.0)
sustained_discharge_allow_melee: Bool(false)
sustained_discharge_duration: Float(0.0)
sustained_discharge_ends_in_primary_attack: Bool(false)
sustained_discharge_pulse_frequency: Float(0.0)
sustained_discharge_require_input: Bool(false)
sustained_discharge_updates_charge: Bool(false)
sustained_discharge_want_pulse_callbacks: Bool(false)
sustained_laser_attachment: String("")
sustained_laser_attachment_scoped: String("")
sustained_laser_damage_effect: Asset
sustained_laser_damage_scale: Float(1.0)
sustained_laser_effect_1p: Asset
sustained_laser_effect_3p: Asset
sustained_laser_effect_loops: Bool(true)
sustained_laser_enabled: Bool(false)
sustained_laser_impact_distance: Float(0.0)
sustained_laser_impact_effect: Asset
sustained_laser_impact_effect_loops: Bool(true)
sustained_laser_impact_effect_table: Asset
sustained_laser_radial_iterations: Int(2)
sustained_laser_radial_step: Int(8)
sustained_laser_radius: Float(15.0)
sustained_laser_range: Float(0.0)
sustained_laser_spread_pattern: Special
sustained_laser_use_deferred_traces: Bool(true)
sway_rotate_scale_unzoomed: Float(1.0)
sway_rotate_scale_zoomed: Float(1.0)
targeting_laser_attachment_1p: String("")
targeting_laser_attachment_3p: String("")
targeting_laser_beam_length_1p: Float(80.0)
targeting_laser_beam_length_3p_enemy: Float(80.0)
targeting_laser_beam_length_3p_friendly: Float(80.0)
targeting_laser_effect_1p: Asset
targeting_laser_effect_3p_enemy: Asset
targeting_laser_effect_3p_friendly: Asset
targeting_laser_enabled: Bool(false)
targeting_laser_range: Float(0.0)
tergeting_laser_use_forward_direction: Bool(false)
thirdperson_fire_from_mount_point: Bool(false)
threat_scope_bounds_height: Float(1.0)
threat_scope_bounds_tagname1: String("")
threat_scope_bounds_tagname2: String("")
threat_scope_bounds_width: Float(1.0)
threat_scope_enabled: Bool(false)
threat_scope_fadeWithDistance: Bool(true)
threat_scope_fadedist_end: Float(16000.0)
threat_scope_fadedist_start: Float(0.0)
threat_scope_zoomToggle_only: Bool(false)
threat_scope_zoomfrac_end: Float(1.0)
threat_scope_zoomfrac_start: Float(0.4)
titanarmor_critical_hit_required: Bool(false)
toss_has_post_loop: Bool(false)
toss_hides_world_model: Bool(true)
toss_overhead_time: Float(0.0)
toss_pullout_time: Float(0.0)
toss_time: Float(0.0)
tossholdsprintcycle_time: Float(0.0)
tracer_effect: Asset
tracer_effect_first_person: Asset
ui10_draw_cloaked: Bool(false)
ui10_enable: Bool(false)
ui10_mesh_override: String("")
ui11_draw_cloaked: Bool(false)
ui11_enable: Bool(false)
ui11_mesh_override: String("")
ui12_draw_cloaked: Bool(false)
ui12_enable: Bool(false)
ui12_mesh_override: String("")
ui13_draw_cloaked: Bool(false)
ui13_enable: Bool(false)
ui13_mesh_override: String("")
ui14_draw_cloaked: Bool(false)
ui14_enable: Bool(false)
ui14_mesh_override: String("")
ui15_draw_cloaked: Bool(false)
ui15_enable: Bool(false)
ui15_mesh_override: String("")
ui16_draw_cloaked: Bool(false)
ui16_enable: Bool(false)
ui16_mesh_override: String("")
ui17_draw_cloaked: Bool(false)
ui17_enable: Bool(false)
ui17_mesh_override: String("")
ui18_draw_cloaked: Bool(false)
ui18_enable: Bool(false)
ui18_mesh_override: String("")
ui19_draw_cloaked: Bool(false)
ui19_enable: Bool(false)
ui19_mesh_override: String("")
ui1_draw_cloaked: Bool(false)
ui1_enable: Bool(false)
ui1_mesh_override: String("")
ui20_draw_cloaked: Bool(false)
ui20_enable: Bool(false)
ui20_mesh_override: String("")
ui21_draw_cloaked: Bool(false)
ui21_enable: Bool(false)
ui21_mesh_override: String("")
ui22_draw_cloaked: Bool(false)
ui22_enable: Bool(false)
ui22_mesh_override: String("")
ui23_draw_cloaked: Bool(false)
ui23_enable: Bool(false)
ui23_mesh_override: String("")
ui24_draw_cloaked: Bool(false)
ui24_enable: Bool(false)
ui24_mesh_override: String("")
ui25_draw_cloaked: Bool(false)
ui25_enable: Bool(false)
ui25_mesh_override: String("")
ui26_draw_cloaked: Bool(false)
ui26_enable: Bool(false)
ui26_mesh_override: String("")
ui27_draw_cloaked: Bool(false)
ui27_enable: Bool(false)
ui27_mesh_override: String("")
ui28_draw_cloaked: Bool(false)
ui28_enable: Bool(false)
ui28_mesh_override: String("")
ui29_draw_cloaked: Bool(false)
ui29_enable: Bool(false)
ui29_mesh_override: String("")
ui2_draw_cloaked: Bool(false)
ui2_enable: Bool(false)
ui2_mesh_override: String("")
ui30_draw_cloaked: Bool(false)
ui30_enable: Bool(false)
ui30_mesh_override: String("")
ui31_draw_cloaked: Bool(false)
ui31_enable: Bool(false)
ui31_mesh_override: String("")
ui32_draw_cloaked: Bool(false)
ui32_enable: Bool(false)
ui32_mesh_override: String("")
ui3_draw_cloaked: Bool(false)
ui3_enable: Bool(false)
ui3_mesh_override: String("")
ui4_draw_cloaked: Bool(false)
ui4_enable: Bool(false)
ui4_mesh_override: String("")
ui5_draw_cloaked: Bool(false)
ui5_enable: Bool(false)
ui5_mesh_override: String("")
ui6_draw_cloaked: Bool(false)
ui6_enable: Bool(false)
ui6_mesh_override: String("")
ui7_draw_cloaked: Bool(false)
ui7_enable: Bool(false)
ui7_mesh_override: String("")
ui8_draw_cloaked: Bool(false)
ui8_enable: Bool(false)
ui8_mesh_override: String("")
ui9_draw_cloaked: Bool(false)
ui9_enable: Bool(false)
ui9_mesh_override: String("")
update_player_last_fire_time: Bool(true)
uses_ammo_pool: Bool(false)
variable_sights_offset_range_1: Float(200.0)
variable_sights_offset_range_2: Float(300.0)
variable_sights_offset_range_3: Float(400.0)
variable_sights_offset_range_4: Float(500.0)
viewdrift_ads_air_scale_pitch: Float(0.0)
viewdrift_ads_air_scale_yaw: Float(0.0)
viewdrift_ads_crouch_scale_pitch: Float(0.0)
viewdrift_ads_crouch_scale_yaw: Float(0.0)
viewdrift_ads_delay: Float(0.0)
viewdrift_ads_speed_pitch: Float(1.0)
viewdrift_ads_speed_yaw: Float(1.0)
viewdrift_ads_stand_scale_pitch: Float(0.0)
viewdrift_ads_stand_scale_yaw: Float(0.0)
viewdrift_hipfire_air_scale_pitch: Float(0.0)
viewdrift_hipfire_air_scale_yaw: Float(0.0)
viewdrift_hipfire_crouch_scale_pitch: Float(0.0)
viewdrift_hipfire_crouch_scale_yaw: Float(0.0)
viewdrift_hipfire_speed_pitch: Float(1.0)
viewdrift_hipfire_speed_yaw: Float(1.0)
viewdrift_hipfire_stand_scale_pitch: Float(0.0)
viewdrift_hipfire_stand_scale_yaw: Float(0.0)
viewkick_ads_weaponFraction: Float(0.0)
viewkick_ads_weaponFraction_vmScale: Float(0.0)
viewkick_air_scale_ads: Float(1.0)
viewkick_duck_scale: Float(1.0)
viewkick_hipfire_weaponFraction: Float(0.0)
viewkick_hipfire_weaponFraction_vmScale: Float(0.0)
viewkick_hover_scale: Float(1.0)
viewkick_move_scale: Float(1.0)
viewkick_pattern: Special
viewkick_pattern_valuePerShot: Float(1.0)
viewkick_pc_pitch_scale: Float(1.0)
viewkick_pc_yaw_scale: Float(1.0)
viewkick_perm_pitch_base: Float(0.0)
viewkick_perm_pitch_random: Float(0.0)
viewkick_perm_pitch_random_innerexclude: Float(0.0)
viewkick_perm_yaw_base: Float(0.0)
viewkick_perm_yaw_random: Float(0.0)
viewkick_perm_yaw_random_innerexclude: Float(0.0)
viewkick_pitch_base: Float(0.0)
viewkick_pitch_hardScale: Float(0.0)
viewkick_pitch_random: Float(0.0)
viewkick_pitch_random_innerexclude: Float(0.0)
viewkick_pitch_softScale: Float(0.0)
viewkick_roll_base: Float(0.0)
viewkick_roll_hardScale: Float(0.0)
viewkick_roll_randomMax: Float(0.0)
viewkick_roll_randomMin: Float(0.0)
viewkick_roll_softScale: Float(0.0)
viewkick_scale_firstshot_ads: Float(0.0)
viewkick_scale_firstshot_hipfire: Float(0.0)
viewkick_scale_max_ads: Float(1.0)
viewkick_scale_max_hipfire: Float(1.0)
viewkick_scale_min_ads: Float(1.0)
viewkick_scale_min_hipfire: Float(1.0)
viewkick_scale_pitch_valueLerpEnd: Float(0.0)
viewkick_scale_pitch_valueLerpStart: Float(0.0)
viewkick_scale_valueDecayDelay: Float(0.0)
viewkick_scale_valueDecayRate: Float(0.0)
viewkick_scale_valuePerShot: Float(0.0)
viewkick_scale_yaw_valueLerpEnd: Float(0.0)
viewkick_scale_yaw_valueLerpStart: Float(0.0)
viewkick_spring: Special
viewkick_spring_cooldown_fadetime: Float(1.0)
viewkick_spring_cooldown_holdtime: Float(0.0)
viewkick_spring_heatpershot: Float(1.0)
viewkick_spring_hot: Special
viewkick_spring_velocityScalePerShot: Float(1.0)
viewkick_yaw_base: Float(0.0)
viewkick_yaw_hardScale: Float(0.0)
viewkick_yaw_random: Float(0.0)
viewkick_yaw_random_innerexclude: Float(0.0)
viewkick_yaw_softScale: Float(0.0)
viewmodel: WeaponString
viewmodel_ads_centerpoint_attachment: String("")
viewmodel_ads_rui_bottomleft_attachment: String("")
viewmodel_jolt_backwardPerShot: Float(0.0)
viewmodel_jolt_roll: Vector
viewmodel_jolt_scale: Float(0.0)
viewmodel_jolt_side: Vector
viewmodel_offset_ads: Vector
viewmodel_offset_ads_by_centerpoint: Bool(false)
viewmodel_offset_hip: Vector
viewmodel_offset_offhand_scale: Float(0.35)
viewmodel_offset_zoom_frac_end: Float(0.5)
viewmodel_offset_zoom_frac_start: Float(0.0)
viewmodel_spring_jolt: Special
vortex_absorb_effect: Asset
vortex_absorb_effect_third_person: Asset
vortex_drain: Float(0.0)
vortex_impact_effect: Asset
weapon_type_flags: Special
zipline_distance_max: Float(10000.0)
zipline_distance_min: Float(350.0)
zipline_grenade: Bool(false)
zipline_grenade_auto_detach_distance: Float(100.0)
zipline_grenade_snap_angle: Float(10.0)
zipline_grenade_snap_distance: Float(100.0)
zipline_indicator_arc_blocked_effect: Asset
zipline_indicator_impact_blocked_effect: Asset
zipline_indicator_impact_ground_effect: Asset
zipline_indicator_impact_wall_effect: Asset
zipline_indicator_line_effect: Asset
zipline_station_animation_begin: String("")
zipline_station_animation_ground: String("")
zipline_station_animation_ledge: String("")
zipline_station_animation_wall: String("")
zipline_station_attachment_ground: String("")
zipline_station_attachment_ledge: String("")
zipline_station_attachment_wall: String("")
zipline_station_model_ground: Asset
zipline_station_model_ledge: Asset
zipline_station_model_wall: Asset
zoom_angle_shift_pitch: Float(0.0)
zoom_angle_shift_yaw: Float(0.0)
zoom_effects: Bool(true)
zoom_fov: Float(40.0)
zoom_fov_viewmodel: Float(0.0)
zoom_scope_frac_end: Float(1.0)
zoom_scope_frac_start: Float(0.0)
zoom_time_in: Float(0.1)
zoom_time_out: Float(0.1)
zoom_toggle_fov: Float(0.0)
zoom_toggle_lerp_time: Float(0.0)
zoomed_convar_sensitivity_index: Int(0)
zoomed_convar_toggle_sensitivity_index: Int(0)
zoomfrac_autoattack: Float(-1.0)
```
...
apply 2d bounds from projection of sphere. this reduces number of tiles to work on.
...
rasterize hexahedron per light. this mode gets tighter ranges (most obviously with z range).
...
Debug only. Lighting mode 1 only. global mutliplier for all emissive textures.
...
Debug only. 0 - off, 1 - only on for lighting_mode 1, 2 - always on.
override falloff with ground truth based falloff. turns on debug shader.
...
Maximum luminance (to be shown as white) for the visualization.
...
Minimum luminance (to be shown as black) for the visualization.
...
Maximum luminance (to be shown as white) for the heatmap visualization.
...
How many pcf samples to take. A value of 'n' means nxn samples across (2n)x(2n) shadow texels. Supports n = {1, 2, 3}
